...
- 当前状态：v0.1 Mac Replay Foundation、v0.2 Mac Local Alpha 与 v0.3 Windows 无终端交付候选已合入本地 `main`，由单一 draft PR #2 同步；`v0.3-windows-data-gate` 仍等待 Human Owner 在真实 Windows + 官方 TdxQuant 完成单人只读 M0。
