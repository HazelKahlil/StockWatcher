...
本目录维护 portable/Inno Setup 配置与 `0.7.0-alpha.3` UI 同步候选（基于 PR #7 桌面稳定性修复）。PR 的 Governance 必须分别在 Windows Python 3.11 与 3.12 完成离线回归、PyInstaller、Inno Setup 和制品上传，才可把本提交称为可重建候选。
