...
import { candidateCardHTML, placeholderCardHTML, levelMeta } from './candidate-card.js?v=4-select';
import { createApprovalController } from './candidate-approvals.js?v=2';
